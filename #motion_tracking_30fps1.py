    ...
    #========================
    # 1. используется калибровка по 2-м точкам и вводу длины
    # на экране нажать с, а затем правой кнопеой мыши
    # кликнуть 2 раза по известной длине
    # затем на терминале ввести длину
    # в метрах (например, 0.45 или 45cm).
    # 2. добавлен вывод движения в диапазоне 10..100 м/с
    ...
    CAM_INDEX = 0
    FPS = 30
    FRAME_WIDTH = 2400 #9152
    FRAME_HEIGHT = 1200 #6944
