...
# ---------------- Настройки trail ----------------
TRAIL_LENGTH = 200   # сколько точек хранить для "следа"
TRAIL_FADE = 5 #10     # шаг затухания (чем больше — быстрее исчезает)
...
SPEED_THRESHOLD_MPS = 0.5 #1.0 #10.0  # порог в м/с для подсветки
